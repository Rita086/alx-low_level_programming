...
/**
 * check_elf - looks if a file is an ELF file.
...
/**
 * close_elf - Finishes an ELF file.
...
/**
 * main - Presents the information contained in the
 * ELF header at the start of an ELF file.
 * @argc: The numb of arguments distributed to the program.
